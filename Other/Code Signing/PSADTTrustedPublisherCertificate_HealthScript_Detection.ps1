<#
.SYNOPSIS
    Proactive Remediation (Health Script) to test if the PSAppDeployToolkit code-signing certificate is installed in the Local Machine Trusted Publisher store.
...
.DESCRIPTION
    This script checks if the PSAppDeployToolkit code-signing certificate is installed in the Local Machine Trusted Publisher store. 
